    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 flex items-center justify-center p-6">
      <Card className="w-full max-w-5xl p-8">
        <h1 className="text-2xl font-bold mb-6 text-center">
          Upload Publication Files and Filters
        </h1>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Excel Upload */}
          <div>
            <Label htmlFor="excel-file" className="block mb-2">
              Upload Excel File
            </Label>
            <Input
              id="excel-file"
          ...
          {/* BibTeX Upload */}
          <div>
            <Label htmlFor="bibtex-file" className="block mb-2">
              Upload BibTeX File
            </Label>
            <Input
              id="bibtex-file"
